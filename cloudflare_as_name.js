...
function mkJSResp(str,etag) {
  ...
  return new Response("var e=document.getElementById('n');e.parentNode.replaceChild(document.createTextNode(" + JSON
    .stringify(str) + "),e)", {
      headers: {

...
.($js?'<link href="//otp-mta-prod.camsys-apps.com" rel="preconnect" crossorigin><link rel="dns-prefetch" href="//otp-mta-prod.camsys-apps.com">':$planner?'<script src=plan.js></script>':'')
.'</head><body><a name="#">
';
